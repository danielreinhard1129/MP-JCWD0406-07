        ...
        <form onSubmit={formik.handleSubmit} style={{ color: '#333' }}>
          <div className="relative mb-2 mt-5">
            <input
              ...
              className="block px-2.5 pb-3 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-gray-600 peer"
              placeholder=" "
